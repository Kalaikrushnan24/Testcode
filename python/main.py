...
def instanceTagFinds():
    ...
    for reservation in (response["Reservations"]):
        for instance in reservation["Instances"]:
            output_dict = [x for x in instance['Tags']
                           if x['Key'] == 'Service' or x['Key'] == 'service']
...
def runingInstanceInformation():
    ...
    for reservation in (reservations["Reservations"]):
        for instance in reservation["Instances"]:
            print("instance_id: {}, instance_type: {}, public_ip: {}, private_ip: {}".format(
                instance["InstanceId"], instance["InstanceType"], instance["PublicIpAddress"], instance["PrivateIpAddress"]))
